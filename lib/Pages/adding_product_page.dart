        ...
        body: new ListView(
          children: <Widget>[
            new Column(
              children: <Widget>[
                new OrderItem(
                    "Назва товару", TextInputType.text, textController: _name),
                new Container(
                  color: Colors.white,
                ...
                new OrderItem(
                  "Короткий опис", TextInputType.text, textController: _about,),
                ...
                new SettingsItem(
                  ...
                  "",
                    ...
                    await ImagePicker.pickImage(
                        source: ImageSource.gallery, maxWidth: 850.0);
                    setState(() {
                      _productImage =
                ...
                new SettingsItem(
                  ...
                  "зберегти зміни",
                    ...
                    CollectionReference goodsReference = Firestore.instance
                        .collection('goods');


                    final DocumentReference document = await goodsReference.add(
                        <String, dynamic>{
                          ...
                          'shop': Firestore.instance.document(
                              "/shops/" + shopID)
                        });

                    CollectionReference shopListReference = Firestore.instance
